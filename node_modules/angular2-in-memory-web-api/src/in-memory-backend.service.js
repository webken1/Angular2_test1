...
var InMemoryBackendService = (function () {
    ...
    InMemoryBackendService.prototype.delete = function (_a) {
        var id = _a.id, collection = _a.collection, collectionName = _a.collectionName, headers = _a.headers /*, req */;
        if (!id) {
    ...
    InMemoryBackendService.prototype.post = function (_a) {
        var collection = _a.collection, /* collectionName, */ headers = _a.headers, id = _a.id, req = _a.req, resourceUrl = _a.resourceUrl;
...
InMemoryBackendService = __decorate([
    ...
    __param(1, core_1.Inject(InMemoryBackendConfig)), __param(1, core_1.Optional()),
